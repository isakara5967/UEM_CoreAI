...
Version: 1.1 (Fixed: relevance_score → memory_relevance for consistency)
"""
...
class MemoryResult:
    ...
    PreData Fields:
        ...
        - memory_relevance: Average relevance of retrieved memories (0.0-1.0)
    ...
    # PreData fields (v1.9) - FIXED: memory_relevance (was relevance_score)
    retrieval_count: Optional[int] = None
    memory_relevance: Optional[float] = None  # FIXED: Consistent with MemoryContext
